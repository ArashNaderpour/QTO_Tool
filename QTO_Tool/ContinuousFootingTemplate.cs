...
namespace QTO_Tool
{
    class ContinuousFootingTemplate
    {
        ...
        public ContinuousFootingTemplate(RhinoObject rhobj, string _layerName, System.Drawing.Color layerColor, double angleThreshold, Dictionary<double, string> floorElevations)
        {
